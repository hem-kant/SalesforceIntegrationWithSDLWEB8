...
namespace CoreServiceWithWeb8.TridionObjects
{
    public class Fields
    {
        ...
        public ItemFieldDefinitionData[] Definitions
        {
            get
            {
                return definitions;
        ...
        {
            return (IEnumerator<Field>)new Helper.FieldEnumerator(this, definitions);
        }
        ...
        public static string[] ForFieldsOf(Fields _data)
        {
            string[] fields = new string[_data.definitions.Length];
            for (var i = 0; i < fields.Length; i++)
            {
                fields[i] = _data.definitions[i].Name;
            }
            return fields;
        }
    }
